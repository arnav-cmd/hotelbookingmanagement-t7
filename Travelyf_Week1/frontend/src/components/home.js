            ...
            <div className='mainhomediv'>
                ...
                <div>
                    <navbar className="homenav">
                        ...
                        <nav><Link  to='./login' style={{textDecoration: 'none',color:'white'}}onMouseOver={e => e.target.style.color = 'black'}onMouseOut={e => e.target.style.color = 'white'}>User</Link></nav>
