...
const Outputa = () => {
  ...
  const handleBookHotel = (hotelName, city,cost,area) => {
    dispatch(hotels({ hotelname: hotelName, city: city,cost:cost,area:area }));
  };
            ...
            >
              ...
              <CardActions>
                ...
                <Button
                  size="small"
                  sx={{ marginLeft: "auto" }}
                  onClick={()=>handleBookHotel(hotel.HotelName,hotel.City,hotel.Cost,hotel.Area)}
                >
